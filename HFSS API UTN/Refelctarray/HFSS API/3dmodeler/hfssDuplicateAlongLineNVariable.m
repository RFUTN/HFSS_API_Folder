...
%				                  [dupBoundaries = true], [attachToOriginal]=true)
% 
% Description :
% -------------
...
% [attachToOriginal] - Duplicates should be attached or not to the originals
% 
% Note :
% ------
...
%            otherwise
function hfssDuplicateAlongLineNVariable(fid, ObjectList, dVector, nClones, ...
				dupBoundaries, attachToOriginal)
...
if isempty(attachToOriginal)
    attachToOriginal=true;
end;
